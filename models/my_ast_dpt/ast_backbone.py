...
class ASTModel(nn.Module):
    def __init__(self, label_dim=527,
        ...
        # use a pretrained models for finetuning
            ...
            try:
                self.p_fshape, self.p_tshape = sd['module.v.patch_embed.proj.weight'].shape[2], sd['module.v.patch_embed.proj.weight'].shape[3]
            ...
            audio_model = ASTModel(fstride=self.p_fshape, tstride=self.p_tshape, fshape=self.p_fshape, tshape=self.p_tshape,
